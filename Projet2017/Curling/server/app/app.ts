...
export class Application {
    ...
    public routes() {
        ...
        // const message: indexRoute.Index = new indexRoute.Index();
        //home page
        router.get('/getleaderboard', index.getScore.bind(index.getScore));
        router.post('/user', index.addUser.bind(index.addUser));
        router.post('/leaderboard', index.addScore.bind(index.addScore));
